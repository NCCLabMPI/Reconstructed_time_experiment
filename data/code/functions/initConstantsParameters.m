...
function initConstantsParameters(subNum)
    ...
    % -----------------------------------------------------
    % Dummy variables
    global Behavior VERBOSE debugFactor
    % -----------------------------------------------------
    % Triggers
...
%     global bitsi_buttonbox bitsi_scanner
     % -----------------------------------------------------
     %Practice
    global MinPracticeHits MaxPracticeHits MaxPracticeFalseAlarms MaxPracticeFalseAlarms_Irrelevant 
    % Diverse
    ...
    NUMBER_OF_TOTAL_TRIALS = 1440; % 1280 non-targets + 160 targets
    ...
    NUMBER_OF_NON_TARGET_SETS_PER_CAT = 16; % 320 non-targets per catergory
    ...
    NUM_NON_TARGETS_CENTER_PER_CAT_PER_MB_TYPE = (160/n_mb_types); % 80 as non-targets, 80 as irrelevants
    ...
    NUM_NON_TARGETS_LEFT_PER_CAT_PER_MB_TYPE = (80/n_mb_types);
    ...
    NUM_NON_TARGETS_RIGHT_PER_CAT_PER_MB_TYPE = (80/n_mb_types);
    ...
    NUM_IRRELEVANTS_CENTER_PER_CAT_PER_MB_TYPE = (160/n_mb_types); % 80 as non-targets, 80 as irrelevants
    ...
    NUM_IRRELEVANTS_LEFT_PER_CAT_PER_MB_TYPE = (80/n_mb_types);
    ...
    NUM_IRRELEVANTS_RIGHT_PER_CAT_PER_MB_TYPE = (80/n_mb_types);
