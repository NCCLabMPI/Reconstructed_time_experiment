...
% Hardware parameters:
global subjectNum TRUE FALSE refRate viewDistance VIEW_DISTANCE compKbDevice
...
viewDistance = input('View Distance in cm [default 69.5]: '); if isempty(viewDistance); viewDistance = 70; end
